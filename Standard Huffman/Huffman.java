...
public class Huffman {
    public static String helpString = "Compression usage: java Huffman.java compress [original file name] [compressed file name]\nDecompression usage: java Huffman.java decompress [compressed file name] [decompressed file name]";
    public static String errMessage = "Invalid Call For Help Type: java Huffman.java help";
